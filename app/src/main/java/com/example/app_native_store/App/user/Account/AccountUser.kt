...
fun AccountUser() {
    ...
    var genero by remember { mutableStateOf(UserInfo.genero) }
    var edad by remember { mutableStateOf(UserInfo.edad.toString()) }
    var descripcion by remember { mutableStateOf(UserInfo.descripcionPerfil) }
                        ...
                        if (!editClave) {
                            ...
                            if (UserInfo.password == clave) {
                                actualizarUsuario(
                                    ...
                                    UserInfo.telefono,
                                    UserInfo.genero,
                                    UserInfo.edad.toString(),
                                    UserInfo.descripcionPerfil,
                                    UserInfo.ciudad,
                                    newClave
                                )
                                editClave = false
